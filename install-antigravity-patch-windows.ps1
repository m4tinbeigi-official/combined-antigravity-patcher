...
#   pwsh ./install-antigravity-patch-windows.ps1             (Applies both patches)
#   pwsh ./install-antigravity-patch-windows.ps1 -RegionOnly (Applies ONLY region bypass)
#   pwsh ./install-antigravity-patch-windows.ps1 -AuthOnly   (Applies ONLY auth/proxy fix)
# ==============================================================================
